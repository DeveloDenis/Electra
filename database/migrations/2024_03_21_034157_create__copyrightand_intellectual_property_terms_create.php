...
return new class extends Migration
{
    ...
    {
        Schema::create('_copyrightand_intellectual_property_terms_create', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('_copyrightand_intellectual_property_terms_create');
    }
};
