...
<div class="container container1 mb-5" id="product-cards">
    ...
    <div class="row my-3" style="margin-top: 30px;">
      ...
      <div class="col-md-10">
             ...
             @endif
                 ...
                 @endphp
                   ...
                   <!--End NewStars-->
                       ...
                       <p style="height:45px; overfow:hidden;" class="mb-4">
                        <b>Description:</b> {{$product->small_description}}
                     </p>
                            
                       <a href="{{route('view.product',$product->id)}}" class="btn btn-outline-primary">View</a>
        ...
        <div class="col-md-12">
         <div class="p-2">
             <h4 class="text-center">No such products found </h4>
         </div>
