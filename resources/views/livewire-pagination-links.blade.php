...
<ul class="pagination pagination-rounded justify-content-center mt-4">
    ...
    @foreach($elements as $element)
      ...
      @if(is_string($element))
        ...
        <li class="page-item disabled" ><a href="" class="page-link"><span>{{$element}}</span></a></li>
      ...
      @if(is_array($element))
         ...
         @if($page == $paginator->currentPage())
              ...
              <li class="page-item active" aria-curent="page"><a href="javascript:;" wire:click="gotoPage({{$page}})" class="page-link"><span>{{$page}}</span></a></li>
