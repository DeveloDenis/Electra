...
<div class="text-center">
    ...
    <p>
        Thank you for purchasing in {{$appSetting->website_name ?? "Electra"}}
    </p>

</div>

<table class="order-details container1">
    <thead>
        <tr>
            <th width="50%" colspan="2">
                <h2 class="text-start"><i class="fa-solid fa-bolt" style="color:#0372EF;"></i> Electra</h2>
            </th>
    ...
    <tbody>
     ...
     @foreach($order->orderItems as $orderItems)
          ...
          <tr>
            ...
            <td width="15%">{{$orderItems->price*$orderItems->quantity}}</td>
...
<br>
<p class="text-center">
    Thank your for shopping with Electra
</p>
